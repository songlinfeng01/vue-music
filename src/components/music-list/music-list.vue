  ...
  <div class="music-list">
    ...
    <div class="bg-image" :style="bgStyle" ref="bgImage">
      <div class="play-wrapper">
        <div class="play" v-show="songList.length" ref="playBtn" @click="random">
          <i class="icon-play"></i>
    ...
    <scroll class="list" @scroll="scroll" :data="songList" ref="list" :probe-type="probeType"
            :listen-scroll="listenScroll">
      <div class="song-list-wrapper">
        <song-list :rank="rank" :songList="songList" @select="selectItem"></song-list>
      </div>
